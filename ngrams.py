...
corpus_dir = '/home/self/git/xtr/data/corpus'

import os, re, string, random, glob, operator, heapq
...
@memo # REMOVE ME
def combine(Pfirst, first, xxx_todo_changeme): 
    "Combine first and rem results into one (probability, words) pair." 
    (Prem, rem) = xxx_todo_changeme
